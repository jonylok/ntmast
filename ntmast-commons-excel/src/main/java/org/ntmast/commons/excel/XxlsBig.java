...
import org.ntmast.commons.datasources.DataSourcess;
...
public class XxlsBig extends XxlsAbstract {   
    ...
    public static void main(String[] args) throws Exception {   
        ...
        howto.processOneSheet("G:\\2013072.xlsx",1);   
...
//		DataSource ds = InstanceFactory.getInstance(DataSource.class,"dataSource");
...
//            	System.out.println(rowlist.get(i));
    ...
    private static Connection getNew_Conn() {   
        ...
        DataSourcess dsf = new DataSourcess();
        DataSource ds = dsf.getDataSource();
//        DataSource ds = InstanceFactory.getInstance(DataSource.class,"myDataSource1");
        try {   
...
//            conn = DriverManager.getConnection(jdbcURLString.toString(), props.getProperty("user"), props.getProperty("password"));   
//        	conn = DriverManager.getConnection("jdbc:jtds:sqlserver://127.0.0.1:1433/nrs2_db", "sa", "nrs123");
        } catch (Exception e) {   
            e.printStackTrace();   
        } finally {   
