package org.ntmast.commons.countmodel;
...
public class SPT {
	 ...
	 *            [n] 存放自变量x的n个取值
	 * @param y
	 *            [n] 存放与自变量x的n个取值相对应的随机变量y的观察值
	 * @param n
	 *            观察点数
	 * @param a
	 *            [2] a(0) 返回回归系数b ,a(1)返回回归系数a
	 * @param dt
	 *            [6] dt(0) 返回偏差平方和q ,dt(1)返回平均标准偏差s ,dt(2)返回回归平方和p,
	 ...
	 *            返回回归系数a0,...,am
	 * @param dt
	 *            [4] dt[0]偏差平方和q,dt[1] 平均标准偏差s dt[2]返回复相关系数r dt[3]返回回归平方和u
	 * @param v
	 *            [m] 返回m个自变量的偏相关系数
	 */
